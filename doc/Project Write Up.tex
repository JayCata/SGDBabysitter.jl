...
\par Next, we employed the Oxford Parkinson's Disease Telemonitoring dataset[cite]. We found similar validation errors for both the vanilla and babysitter implementations.
\begin{figure}[H]
	\centering
